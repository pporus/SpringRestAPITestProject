...
class SpringRestApiTestProjectApplicationTests {
	 ...
	 * MockMVC class is part of Spring MVC test framework which helps in testing the
	 * controllers explicitly starting a Servlet container.
	 * 
	 * 
	 * 
	 * 
	 * @BeforeEach public void contextLoads() {
	 * 
	 * mockMvc=MockMvcBuilders.webAppContextSetup(webApplicationContext).build();
	 * 
	 * }
	 * 
	 * @Test public void testBLITEmployee() throws Exception {
	 * 
